...
_UNIVERSE: list[AssetMeta] = [
    ...
    AssetMeta("SEK=X", "fx_g10", 2.0, quote_convention="USD_base"),
    AssetMeta("NOK=X", "fx_g10", 2.0, quote_convention="USD_base"),
    ...
    AssetMeta("SGD=X", "fx_em", 8.0, quote_convention="USD_base"),
    AssetMeta("TWD=X", "fx_em", 8.0, quote_convention="USD_base"),
    AssetMeta("BRL=X", "fx_em", 8.0, quote_convention="USD_base"),
    # --- FX crosses (3 bps) ---
    ...
    AssetMeta("AUDJPY=X", "fx_cross", 3.0, quote_convention="cross"),
    AssetMeta("CADJPY=X", "fx_cross", 3.0, quote_convention="cross"),
    AssetMeta("NZDJPY=X", "fx_cross", 3.0, quote_convention="cross"),
    AssetMeta("EURCHF=X", "fx_cross", 3.0, quote_convention="cross"),
    AssetMeta("GBPCHF=X", "fx_cross", 3.0, quote_convention="cross"),
    AssetMeta("EURAUD=X", "fx_cross", 3.0, quote_convention="cross"),
    AssetMeta("AUDNZD=X", "fx_cross", 3.0, quote_convention="cross"),
    ...
    AssetMeta("^STOXX50E", "equity_index", 1.5),
    AssetMeta("^SSMI", "equity_index", 1.5),
    AssetMeta("^AEX", "equity_index", 1.5),
    AssetMeta("^IBEX", "equity_index", 1.5),
    # EM indices: wider costs
    AssetMeta("^BVSP", "equity_index", 3.0),
    AssetMeta("^MXX", "equity_index", 3.0),
    AssetMeta("^TWII", "equity_index", 3.0),
    AssetMeta("^NSEI", "equity_index", 3.0),
    AssetMeta("^JKSE", "equity_index", 3.0),
    ...
    AssetMeta("PL=F", "commodity", 3.0),
    AssetMeta("PA=F", "commodity", 3.0),
    AssetMeta("RB=F", "commodity", 3.0),
    AssetMeta("HO=F", "commodity", 3.0),
    AssetMeta("ZC=F", "commodity", 3.0),
    AssetMeta("ZS=F", "commodity", 3.0),
    AssetMeta("ZW=F", "commodity", 3.0),
    AssetMeta("KC=F", "commodity", 3.0),
    AssetMeta("SB=F", "commodity", 3.0),
    AssetMeta("CT=F", "commodity", 3.0),
    AssetMeta("CC=F", "commodity", 3.0),
    AssetMeta("LE=F", "commodity", 3.0),
    AssetMeta("HE=F", "commodity", 3.0),
    # --- Bond futures (1 bp) ---
    AssetMeta("ZB=F", "bond_fut", 1.0),
    AssetMeta("ZN=F", "bond_fut", 1.0),
    AssetMeta("ZF=F", "bond_fut", 1.0),
    AssetMeta("ZT=F", "bond_fut", 1.0),
    AssetMeta("UB=F", "bond_fut", 1.0),
    ...
    AssetMeta("SOL-USD", "crypto", 10.0),
    AssetMeta("XRP-USD", "crypto", 10.0),
